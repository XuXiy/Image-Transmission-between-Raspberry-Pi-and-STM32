...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   ////	 Macro for Test Type(Chinese：测试类型宏定义)
	 #define TEST_M8266WIFI_TYPE    2	     //           1 = Repeative Sending, 2 = Repeative Reception, 3 = Echo  4 = multi-clients transimission test
...
#error WRONG TEST_CONNECTION_TYPE defined !
   ...
   #define TEST_REMOTE_ADDR    	 	"192.168.3.75"  // "www.baidu.com"
   #define TEST_REMOTE_PORT  	    8941					// 80
...
//#define  RECV_DATA_MAX_SIZE  1024      // If using large size of array, ensure system stack is large engough for the array variable。 Or stack over-bound leakage might bring about the mcu into "hardware fault exception" 
   ...
   u8  RecvData[RECV_DATA_MAX_SIZE]={0};    // (Chinese: 如果使用较大的数组，记得确保有足够大的系统堆栈来容纳这个大数组变量. 否则，单片机程序可能会因为堆栈溢出越界而跳入“hardware fault"系统异常) 
   u16 received = 0;                   
